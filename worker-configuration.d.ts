/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9b524e346c8428d2922df41d5371327b)
// Runtime types generated with workerd@1.20260317.1 2026-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ServerHub";
	}
	interface Env {
		KV: KVNamespace;
		DB: D1Database;
		...
		WORKER_URL: string;
		SERVER_HUB: DurableObjectNamespace<import("./src/index").ServerHub>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STEAM_API_KEY" | "WORKER_URL">> {}
}
